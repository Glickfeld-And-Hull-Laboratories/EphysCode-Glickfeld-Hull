function [suppressedPairs_CS_SS, pairs_CS_SS] = ccgAnalyses(unitGoodSorted, unitMuaSorted, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials)
    ...
    if UNIT_OF_INTEREST~= -1
        ...
        if ~isempty(unitOfInterest)
            ...
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_CS) || strcmp(unitOfInterest.neuronType, NEURON_TYPE_SS)
                ...
                [suppressedPairs_CS_SS, ~] = plotCCGPairs(pairs_CS_SS, '', PAIR_TYPE_CS_SS, units, unitOfInterest.neuronType, otherNeuronType, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
...
%                 end
%                 [suppressedPairs_DCS_SS, ~] = plotCCGPairs(pairs_DCS_SS, '', PAIR_TYPE_CS_SS, units, unitOfInterest.neuronType, otherNeuronType, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
%             end
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_MFB) || strcmp(unitOfInterest.neuronType, NEURON_TYPE_GoC)
                ...
                [suppressedPairs_MF_GO, ~] = plotCCGPairs(pairs_MF_GO, '', PAIR_TYPE_MF_GO, units, unitOfInterest.neuronType, otherNeuronType, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_GoC) || strcmp(unitOfInterest.neuronType, NEURON_TYPE_SS)
                ...
                [suppressedPairs_GO_SS, ~] = plotCCGPairs(pairs_GO_SS, '', PAIR_TYPE_GO_SS, units, unitOfInterest.neuronType, otherNeuronType, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_MLI) || strcmp(unitOfInterest.neuronType, NEURON_TYPE_SS)
                ...
                [suppressedPairs_MLI_SS, ~] = plotCCGPairs(pairs_MLI_SS, '', PAIR_TYPE_MLI_SS, units, unitOfInterest.neuronType, otherNeuronType, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_MFB) || strcmp(unitOfInterest.neuronType, NEURON_TYPE_SS)
                ...
                [suppressedPairs_MF_SS, ~] = plotCCGPairs(pairs_MF_SS, '', PAIR_TYPE_MF_SS, units, unitOfInterest.neuronType, otherNeuronType, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end            
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_SS) || strcmp(unitOfInterest.neuronType, NEURON_TYPE_DCN)
                ...
                [suppressedPairs_SS_DCN, ~] = plotCCGPairs(pairs_SS_DCN, '', PAIR_TYPE_SS_DCN, units, unitOfInterest.neuronType, otherNeuronType, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
            ...
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_MLI)
                ...
                [suppressedPairs_MLI_MLI, ~] = plotCCGPairs(pairs_MLI_MLI, '', PAIR_TYPE_MLI_MLI, units,NEURON_TYPE_MLI,NEURON_TYPE_MLI, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_GoC)
                pairs_GO_GO = findPairs(units, PAIR_TYPE_GO_GO, NEURON_TYPE_GoC, NEURON_TYPE_GoC, PAIR_GO_GO_MAX_LAYER_DISTANCE, unitOfInterest);
                [suppressedPairs_GO_GO, ~] = plotCCGPairs(pairs_GO_GO, '', PAIR_TYPE_GO_GO, units,NEURON_TYPE_GoC,NEURON_TYPE_GoC, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
            if strcmp(unitOfInterest.neuronType, NEURON_TYPE_SS)
                pairs_SS_SS = findPairs(units, PAIR_TYPE_SS_SS, NEURON_TYPE_SS, NEURON_TYPE_SS, PAIR_SS_SS_MAX_LAYER_DISTANCE, unitOfInterest);
                [suppressedPairs_SS_SS, ~] = plotCCGPairs(pairs_SS_SS, '', PAIR_TYPE_SS_SS, units,NEURON_TYPE_SS,NEURON_TYPE_SS, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
            end
        end
        ...
        [suppressedPairs_CS_SS, ~] = plotCCGPairs(pairs_CS_SS, '', PAIR_TYPE_CS_SS, unitGoodSorted,NEURON_TYPE_CS,NEURON_TYPE_SS, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
        [suppressedPairs_MF_GO, ~] = plotCCGPairs(pairs_MF_GO, '', PAIR_TYPE_MF_GO, unitGoodSorted,NEURON_TYPE_MFB,NEURON_TYPE_GoC, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
        ...
        [suppressedPairs_MLI_SS, ~] = plotCCGPairs(pairs_MLI_SS, '', PAIR_TYPE_MLI_SS, unitGoodSorted,NEURON_TYPE_MLI,NEURON_TYPE_SS, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
        [suppressedPairs_MF_SS, ~] = plotCCGPairs(pairs_MF_SS, '', PAIR_TYPE_MF_SS, unitGoodSorted,NEURON_TYPE_MFB,NEURON_TYPE_SS, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);      
        ...
        [suppressedPairs_MLI_MLI, ~] = plotCCGPairs(pairs_MLI_MLI, '', PAIR_TYPE_MLI_MLI, unitGoodSorted,NEURON_TYPE_MLI,NEURON_TYPE_MLI, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
        ...
        plotCCGPairs(pairs_Other_MF, '', PAIR_TYPE_OTHER_MF, unitGoodSorted,NEURON_TYPE_OTHER,NEURON_TYPE_MFB, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);
        ...
        plotCCGPairs(pairs_Other_MLI, '', PAIR_TYPE_OTHER_MLI, unitGoodSorted,NEURON_TYPE_OTHER,NEURON_TYPE_MLI, preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, 0);

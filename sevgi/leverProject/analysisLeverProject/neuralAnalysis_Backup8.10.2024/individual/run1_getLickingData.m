...
fileIDOffset = fopen([pathToCatGTFolder 'matlabGen_subthresholdOnsetTimes.txt'],'w');
fprintf(fileIDOffset,'%10.13f\r\n',subthresholdOnsetTimes);

fileIDOffset = fopen([pathToCatGTFolder 'matlabGen_subthresholdOffsetTimes.txt'],'w');

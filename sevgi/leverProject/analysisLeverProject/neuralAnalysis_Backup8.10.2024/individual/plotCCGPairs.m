...
function [suppressedPairs, singleUnit] = plotCCGPairs(pairs, unitCategory, pairType, units, sPair1, sPair2,preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, arrHitTrials, arrMissTrials, arrFaTrials, isACG)
    globals;
    nPairs = size(pairs,1);
    ...
    if ~isempty(pairs)        
        for iPair=1:nPairs
            ...
            if ~isempty(unitPair1) && ~isempty(unitPair2) % && unitPair1.id==297 && unitPair2.id == 279 %&& unitPair1.id==339 && unitPair2.id == 97 %&& unitPair1.id==291 && unitPair2.id == 285
                ...
                [suppressedAll, singleUnit] = plotCCG(ccgType, unitCategory, unitPair1.id, unitPair2.id, unitPair1.spikeTimesSecs', unitPair2.spikeTimesSecs', preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, allTrials, [sPair1 '(' num2str(unitPair1.depth) 'um) ' sPair2 '(' num2str(unitPair2.depth) 'um)'], isACG, unitPair1.neuronType);
...
%                     [suppressedHit, ~] = plotCCG(ccgType, unitCategory, unitPair1.id, unitPair2.id, unitPair1.spikeTimesSecs', unitPair2.spikeTimesSecs', preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, arrHitTrials, ['HIT ' sPair1 '(' num2str(unitPair1.depth) 'um) ' sPair2 '(' num2str(unitPair2.depth) 'um)'], isACG);
%                     
...
%                     [suppressedMiss, ~] = plotCCG(ccgType, unitCategory, unitPair1.id, unitPair2.id, unitPair1.spikeTimesSecs', unitPair2.spikeTimesSecs', preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, arrMissTrials, ['MISS ' sPair1 '(' num2str(unitPair1.depth) 'um) ' sPair2 '(' num2str(unitPair2.depth) 'um)'], isACG);
%                     
...
%                     [suppressedFa, ~] = plotCCG(ccgType, unitCategory, unitPair1.id, unitPair2.id, unitPair1.spikeTimesSecs', unitPair2.spikeTimesSecs', preHoldTime, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, arrStimTurnedOnTrials, arrFaTrials, ['FA ' sPair1 '(' num2str(unitPair1.depth) 'um) ' sPair2 '(' num2str(unitPair2.depth) 'um)'], isACG);
%                 end

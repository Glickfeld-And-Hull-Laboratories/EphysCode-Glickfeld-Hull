function plotPSTH_AllvsHFM(recordingDay, neuronType, trialCounts, spikeRatesFixedAll, spikeRatesRandomAll, spikeRatesFixedHFM, spikeRatesRandomHFM, ...
    ...
    sGlobalTitle = [recordingDay ' ' neuronType '(n=' num2str(size(spikeRatesFixedAll,1)) ') trials=' num2str(allTrialCount)];

    spikeRates = {{spikeRatesFixedAll}, {spikeRatesRandomAll}};
    sFullFileName = [pathToFigureFolder CELL_TYPES_FOLDER recordingDay '_' neuronType '_psth_' sFileName '_All_xlim_' num2str(preTime) '_' num2str(postTime) '.tif'];
    ...
    sFullFileName = [pathToFigureFolder CELL_TYPES_FOLDER recordingDay '_' neuronType '_psth_' sFileName '_HFM_xlim_' num2str(preTime) '_' num2str(postTime) '.tif'];

function [spikeRatesRandom, spikeRatesFixed, responseTypeFixed] = plotPSTH(unitID, neuronType, layer, channel, allTrialCount, cellSpikeTimes, fixedHoldStartsAtTrial, behavRelevantTimes1, behavRelevantTimes2, preTime, postTime, edges, sTitleFixed, sTitleRandom, sFileName, strTrialType, colors, lineColors)
        globals;

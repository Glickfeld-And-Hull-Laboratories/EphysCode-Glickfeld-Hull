function saveUnitswBehavVars(unitGood, unitMua, leverHoldTimes, leverReleaseTimesGLX, targetStimTimesGLX, baselineStimTimesGLX, trialCutIndex, ...
    ...
    if ~exist(unitsAndVarsPath,'file')
        ...
        if UNIT_OF_INTEREST~= -1
            ...
            if ~isempty(unit)
                    ...
                    newUnit.expertLabel = unit.expertLabel;

...
function plotRasterLeverVisStim(unitID, neuronType, layer, channel, allTrialCount, spikeTimeAlignedToLeverHold, spikeTimeAlignedToLeverRelease, spikeTimeAlignedToTargetVisStim, spikeTimeAlignedToBaselineVisStim, ...

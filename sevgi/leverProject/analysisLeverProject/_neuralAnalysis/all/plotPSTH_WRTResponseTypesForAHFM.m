function plotPSTH_WRTResponseTypesForAHFM(recordingDay, expertLabel, responseTypeAll, spikeRatesAll, responseTypeHFM, spikeRatesHFM, ...
    preTime, postTime, edges, sFileName, sGlobal, trialCount)
        ...
        if hasAnyNonEmpty
            ...
            if ~isempty(spikeRatesAllInc) || ~isempty(spikeRatesAllDec) || ~isempty(spikeRatesAllNoCh)
                ...
                sGlobalTitle = [recordingDay ' ' sGlobal ' ALL ' expertLabel ' n=' num2str(length(spikeRatesAll)) ' trials=' num2str(trialCount)];
                sFullFileName = [pathToFigureFolder RESPONSE_TYPES_FOLDER recordingDay '_' expertLabel '_psth_' sFileName '_All_IncDecMixed_xlim_' num2str(preTime) '_' num2str(postTime) '.tif'];
            ...
            if ~isempty(spikeRatesHitInc) || ~isempty(spikeRatesHitDec) || ~isempty(spikeRatesHitNoCh)
                ...
                sGlobalTitle = [recordingDay ' ' sGlobal ' HIT ' expertLabel ' n=' num2str(length(spikeRatesHit)) ' trials=' num2str(trialCount)];
                sFullFileName = [pathToFigureFolder RESPONSE_TYPES_FOLDER recordingDay '_' expertLabel '_psth_' sFileName '_Hit_IncDecMixed_xlim_' num2str(preTime) '_' num2str(postTime) '.tif'];
                plotPSTHs(spikeRatesGrouped, {}, {}, preTime, postTime, edges, ...
            ...
            if length(responseTypeHFM{1})==3 % Hold/Release calling: HFM                
                ...
                if ~isempty(spikeRatesFaInc) || ~isempty(spikeRatesFaDec) || ~isempty(spikeRatesFaNoCh)
                    ...
                    sGlobalTitle = [recordingDay ' ' sGlobal ' FA ' expertLabel ' n=' num2str(length(spikeRatesFa)) ' trials=' num2str(trialCount)];
                    sFullFileName = [pathToFigureFolder RESPONSE_TYPES_FOLDER recordingDay '_' expertLabel '_psth_' sFileName '_Fa_IncDecMixed_xlim_' num2str(preTime) '_' num2str(postTime) '.tif'];
                    plotPSTHs(spikeRatesGrouped, {}, {}, preTime, postTime, edges, ...
                ...
                if ~isempty(spikeRatesMissInc) || ~isempty(spikeRatesMissDec) || ~isempty(spikeRatesMissNoCh)
                    ...
                    sGlobalTitle = [recordingDay ' ' sGlobal ' MISS ' expertLabel ' n=' num2str(length(spikeRatesMiss)) ' trials=' num2str(trialCount)];
                    sFullFileName = [pathToFigureFolder RESPONSE_TYPES_FOLDER recordingDay '_' expertLabel '_psth_' sFileName '_Miss_IncDecMixed_xlim_' num2str(preTime) '_' num2str(postTime) '.tif'];
                    plotPSTHs(spikeRatesGrouped, {}, {}, preTime, postTime, edges, ...

...
function plotAmplitudeHeatMap(unit)
    ...
    xvalues = [0:PLOT_MATRIX_COLUMNS-1];
    yvalues = PLOT_MATRIX_COLUMNS*[PLOT_MATRIX_ROWS-1:-1:0];
...
%     end
    reshapedArr = reshape(unit.amplitudePerChannel, PLOT_MATRIX_COLUMNS, PLOT_MATRIX_ROWS)';
    cdata = reshapedArr(PLOT_MATRIX_ROWS:-1:1,:);

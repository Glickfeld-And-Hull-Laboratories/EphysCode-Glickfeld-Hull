function printRefractorinessWLlobet(unitAll)
    globals;
...
%         plotAmplDistribution_Curation(relativeSpkTimesMsec, targetSpikeRates, acg_edges, unit, singleUnit, refractoryViolationRate, refractoryViolationRateMF, refractoryViolationRateLlobet, isInterrupted, plotStartTime, roiEndTimeSec, interruptionMoments);
    ...
    logger.info('printRefractorinessWLlobet', '********************** GOOD UNITS WITH NO INTERRUPTION ***************************');
    logger.info('printRefractorinessWLlobet', strSingle);
    logger.info('printRefractorinessWLlobet', '********************** GOOD UNITS WITH INTERRUPTION: Check if they are really interrupted! If so, these are potential NOISE UNITS ***************************');
    logger.info('printRefractorinessWLlobet', strNoise);
    logger.info('printRefractorinessWLlobet', '********************** MULTI UNITS WITH REFRACTORY VIOLATIONS ***************************');
    logger.info('printRefractorinessWLlobet', strMulti);
    logger.info('printRefractorinessWLlobet', '********************** DCN UNITS FOR FUTURE PROJECTS ***************************');
    logger.info('printRefractorinessWLlobet', strDCN);
    logger.info('printRefractorinessWLlobet', '********************** OUTSIDE UNITS (PUT INTO NOISE) ***************************');
    logger.info('printRefractorinessWLlobet', strOut);

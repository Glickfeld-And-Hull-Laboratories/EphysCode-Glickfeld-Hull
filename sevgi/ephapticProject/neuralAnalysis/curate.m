function curate(unitIdsSingle, unitIdsMulti, unitIdsNoise)
    ...
    clusterInfoBackupFileName = [pathKS 'cluster_info_backupBeforeMatlabCuration.tsv'];
    clusterGroupBackupFileName = [pathKS 'cluster_group_backupBeforeMatlabCuration.tsv'];
    ...
    if ~isempty(stillUnprocessedUnitIds)
    ...
    clusterInfoBackupFileName = [pathKS 'cluster_info_backupAfterMatlabCuration.tsv'];
    clusterGroupBackupFileName = [pathKS 'cluster_group_backupAfterMatlabCuration.tsv'];
    ...
    logger.info('printRefractoriness', ['******** CURATION IS DONE: ' newline 'Good:' num2str(unitIdsSingle) newline ' Multi:' num2str(unitIdsMulti) newline ' Noise:' num2str(unitIdsNoise) ' ********']);
end
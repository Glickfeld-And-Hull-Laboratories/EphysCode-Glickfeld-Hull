...
if isempty(varargin )
    ...
    rezFullPath = fullfile( '/mnt/DdriveL/sevgi/Neuropixels/uhd_recordings/20240422_UHDType3_g0/KS_OUT_Th7_7_catGT/', 'rez.mat' );
    modStr = 'ksfiltered';
    %[mmName, mmPath] = uigetfile('*.meta','Select original metadata file');
    modelMetaFullPath = fullfile('/mnt/DdriveL/sevgi/Neuropixels/uhd_recordings/20240422_UHDType3_g0/', '20240422_UHDType3_g0_t0.imec0.ap.meta'); %mmPath, mmName);

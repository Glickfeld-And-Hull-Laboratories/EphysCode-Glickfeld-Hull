...
function [layerStruct] = getSpectrolaminarMotifLFP_V1(exptStruct)
...
% Create LFP window around Stim On times
    ...
    figure;
        ...
        print(fullfile(['\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\' loc '\Analysis\Neuropixel\' date '\' mouse '-' date '-findLayer4-Maier.pdf']),'-dpdf','-bestfit')
        %print(fullfile(['/home/smg92@dhe.duke.edu/GlickfeldLabShare/All_Staff/home/' loc '/Analysis/Neuropixel/' date '/' mouse '-' date '-findLayer4-Maier.pdf']),'-dpdf','-bestfit')

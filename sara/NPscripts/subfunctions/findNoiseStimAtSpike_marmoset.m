...
function [trialIdx, frameIdx] = findNoiseStimAtSpike_marmoset(spikeTime, timestamps, timeBeforeSpike)
    ...
    for it = 1:nTrials
        ...
        for ff = 1:nFrames
            ...
            if ff < nFrames
                ...
                frameEnd = frameStart + 0.01;  % last frame ends 0.01s after its timestamp
            end

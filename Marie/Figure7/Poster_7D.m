...
title('trained click resp w_wo tone_inclPartTrain');
 FigureWrap(NaN, 'Trained_Sspk_pred_incPartTrain_Spk_IncTone_EarlyLate', NaN, NaN, NaN, NaN, 2.5, 3.5);
...
% % FigureWrap(NaN, 'Trained_Sspk_pred_incPartTrain_deltaSpk_lickHist_IncTone_EarlyLate', NaN, NaN, NaN, NaN, 2.5, 3.5);
% 
% 
% figure
% hold on
...
% %ylim([-1 7]);
% title('trained click resp w/wo tone inclPartTrain_');
% % FigureWrap(NaN, 'Trained_Sspk_pred_incPartTrain_deltaSpk_locoSpeed_IncTone_EarlyLate', NaN, NaN, NaN, NaN, 2.5, 3.5);

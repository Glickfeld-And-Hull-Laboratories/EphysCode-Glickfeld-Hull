...
figure
h = pie([counterNaiveResp/total counterNaiveNoMod/total], {[num2str(round(100*counterNaiveResp/(counterNaiveNoMod+counterNaiveResp))) '% Resp. unexpected reward']; 'No resp. unexepected reward'});

...
xlabel('time from rewarded solenoid (s)');
ylabel('Sspk/s')
FigureWrap(NaN, 'Trained_Sspk_PAIRED_mod_notMod_juiceClk_withCspkTone', NaN, NaN, NaN, NaN, 2.5, 1.75);
...
FigureWrap(NaN, 'Trained_Sspk_PAIRED_mod_notMod_juiceClk_withCspk_lickHist', NaN, NaN, NaN, NaN, 1, 1.5);

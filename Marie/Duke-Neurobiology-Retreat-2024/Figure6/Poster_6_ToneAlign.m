...
ylim([70 125]);
title('predictions');
 FigureWrap(NaN, 'Trained_Sspk_predictTrials_incPartTrain_Spk_Inc_DecTone', NaN, NaN, NaN, NaN, 2.5, 3.5);
...
shadedErrorBar2(N_p_Dec(1).RunEdges(1:end), nanmean(cell2mat({N_p_Dec.RunMean}), 2), nanstd(cell2mat({N_p_Dec.RunMean}), 0, 2)/sqrt(size(cell2mat({N_p_Dec.RunMean}), 2)), 'LineProp', {C(9,:)});
...
ylim([0 14]);
title('reactions');
 FigureWrap(NaN, 'LickHistReact', NaN, NaN, NaN, NaN, 2.5, 3.5);
figure
hold on
...
ylim([0 14]);
title('misses');
 FigureWrap(NaN, 'LickHistMiss', NaN, NaN, NaN, NaN, 2.5, 3.5);
figure
hold on
...
ylim([0 14]);
title('predictions');
 FigureWrap(NaN, 'LickHistPredict', NaN, NaN, NaN, NaN, 2.5, 3.5);

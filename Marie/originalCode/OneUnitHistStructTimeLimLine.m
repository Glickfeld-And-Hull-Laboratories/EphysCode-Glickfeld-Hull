...
function  [N, edges] = OneUnitHistStructTimeLimLine(TS1, n, struct, xmin, xmax, bwidth, timeLim, STDEV, color, DisplayName, stdevlineboo)
title2 = [num2str(n)];
...
[N, ~] = FreqLine(N, edges, length(TS1), color, DisplayName, 1);

function [SumSt, MLI_PC] = MLI_PCmakerLines_TG_nullFR(SumSt, RecordingList, MEH_chanMap)    
...
%                     end
        ...
        % MLI_PC(counter).dist = Cell2CellDistINDEXchannel(SumSt, n, m, MEH_chanMap);
    ...
    %title(['MLI_PC index = ' num2str(n)])
     ...
     % MLI_PC_thisone(MLI_PC_counter).MLI_PC_dist = Cell2CellDistINDEXchannel(SumSt, n, m, MEH_chanMap);

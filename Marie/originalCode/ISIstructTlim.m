...
function ISIstructTlim(struct, unit, TimeLim, range, bwidth)
...
unitTS = unitTS((TimeLim(1) < unitTS) & (unitTS < TimeLim(2))); %%%% adjust here to change tlim structure
...
title([' ISI ' num2str(unit) ' between ' num2str(TimeLim(1)) ' and ' num2str(TimeLim(2))])
box off
ax = gca; 
ax.TickDir = 'out';

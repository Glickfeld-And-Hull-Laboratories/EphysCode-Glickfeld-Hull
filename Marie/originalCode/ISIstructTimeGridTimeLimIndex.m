...
function [medianISI, meanISI, N, edges] = ISIstructTimeGridTimeLimIndex(TimeGridA, TimeGridB, struct, n, range, TimeLim, bwidth, color, plotBoo, FaceAlpha)
...
if plotBoo == 1
title([' ISI ' num2str(n) ' between ' title3 ' and ' title4 'TG'])

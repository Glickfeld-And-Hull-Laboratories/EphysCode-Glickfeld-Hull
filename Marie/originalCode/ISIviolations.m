...
function [N, edges] = ISIviolations(TimeGridA, TimeGridB, struct, xmin, xmax, bwidth, unit, TimeLim, color) %times in seconds, n unit of interest for struct (.unitID= string, .timestamps= vector 

...
function [time, Waveforms, SampleTS] = SampleWaveformsTimeLimNew(struct, dataLength, n, timeLim, unit, chan)
title1 = ['Unit ' num2str(unit)];
title2 = ['chan ' num2str(chan)];
title3 = [num2str(timeLim(1))];
title4 = [ num2str(timeLim(2))];
title_ = [title1 ' on ' title2 ' between ' title3 ' and ' title4];

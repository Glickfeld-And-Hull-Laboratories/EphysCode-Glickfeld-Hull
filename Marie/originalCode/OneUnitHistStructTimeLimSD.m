...
function  [N, edges, SDline, BinCounts] = OneUnitHistStructTimeLimSD(TS1, n, struct, xmin, xmax, bwidth, timeLim, STDEV, color, FaceAlpha, stdevlineboo)
...
SDline = meanLine + STDEV*stdevLine;

function [UnitStruct] = CreateUnivStruct(cluster, SpikeTimes, clustersAllST, spike_amplitudes) % pass only good clusters to get struct of good units & timestamps
clear k
clear j
clear log1
clear k1

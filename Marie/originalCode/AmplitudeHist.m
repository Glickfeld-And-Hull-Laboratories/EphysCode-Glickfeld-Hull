function AmplitudeHistNew (unit, struct, color)
...
figure
barh(BinEdges, AdjValues, 1, 'Facecolor', color); %'BaseValue', (timestamps(end) + .01*timestamps(end)) ); using the baseValue puts a subtle gray line I can't get rid off

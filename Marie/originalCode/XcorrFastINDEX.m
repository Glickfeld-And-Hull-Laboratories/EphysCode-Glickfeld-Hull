...
function [N, edges] = XcorrFastINDEX(struct, xmin, xmax, bwidth, unit1, unit2, limMin, limMax, color, plotBoo, SD, SDboo) %times in seconds, n unit of interest for struct (.unitID= string, .timestamps= vector 

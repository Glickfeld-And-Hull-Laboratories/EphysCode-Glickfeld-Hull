...
function [N, edges, Values1] = XcorrFastINDEX_TG(struct, xmin, xmax, bwidth, unit1, unit2, TimeGridA, TimeGridB, limMin, limMax, color, plotBoo, SD, SDboo) %times in seconds, n unit of interest for struct (.unitID= string, .timestamps= vector 

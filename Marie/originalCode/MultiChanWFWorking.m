function [time, MainWaveforms, MultiChanWFStruct, Scale] = MultiChanWF(struct, dataLength, n, timeLim, TimeGridA, TimeGridB, unit, map, color, PlotSamps, PlotMean, ScalePass)

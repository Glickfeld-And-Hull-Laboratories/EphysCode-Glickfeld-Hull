...
function  useDeltas = OneUnitHistStructTimeLimTry(TS1, n, struct, xmin, xmax, bwidth, timeLim)
...
N = FreqHist(N, edges, length(TS1), 'k'); % because we are counting through the trials with the spiketimes, not the triggers

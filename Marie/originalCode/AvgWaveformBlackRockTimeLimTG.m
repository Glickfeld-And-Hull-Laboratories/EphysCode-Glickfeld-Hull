function [Waveforms, AvgWvF, time] = AvgWaveformBlackRockTimeLimTG(TimeGridA, TimeGridB, RawData, timeLim, timestamps, n, color1, color2, plotSingleWFs)
%Limits to times between each TimeGridA & TimeGridB
title_ = 'WF';
dataLength = .003;
SampRate = 30000;

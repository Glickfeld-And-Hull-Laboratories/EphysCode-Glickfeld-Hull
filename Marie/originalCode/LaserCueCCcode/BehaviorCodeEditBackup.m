...
UnexpNum = 15; %number of trials in a block of 20 that will be unexpected; do not let UnexpNum + OmitNum > 20
OmitBoo = 0;        %make this zero if you want no omitted trials
OmitNum = 18;  %number of trials in a block of 20 that will be omitted trials; do not let UnexpNum + OmitNum > 20

function [RTs, JuiceLicks] = findRTNew(JuiceLicks)
%some variables you might want to change
burstLimit = 1;  %The time window for three licks to occur to be considered a burst in sec
responseWinMax = 5; % The time window the lick has to occur in to be considered a response
delayTime= .683; %the time between the tone and the juice, in seconds

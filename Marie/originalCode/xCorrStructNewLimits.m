...
function xCorrStructNewLimits(struct, xmin, xmax, bwidth, unit1, unit2, limMin, limMax, color) %times in seconds, n unit of interest for struct (.unitID= string, .timestamps= vector 
...
if (meanLine - 3*stdevLine) >0
yline((meanLine - 3*stdevLine), 'y', 'LineWidth', 2);
end

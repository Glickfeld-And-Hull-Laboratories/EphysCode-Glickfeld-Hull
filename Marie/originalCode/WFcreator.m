function [WF, wfStructStruct] = CellCharWorkupNoFigs(unit, struct, trigger, TimeGridA, TimeGridB, xmin, xmax, TrigMin, TrigMax, TimeLimBase, TimeLim1, TimeLim2, ISIxaxis, binsize, color, nametag, JuiceTimes, LickTimes, RTs, JuiceBin, map)

...
TrainingData(1).day18 = TrainingData_1694(19);
TrainingData(1).day18 = TrainingData_1694(20);

TrainingData(2).animal = 1695;
TrainingData(2).day1 = TrainingData_1695(1);
TrainingData(2).day2 = TrainingData_1695(2);
TrainingData(2).day3 = TrainingData_1695(3);
TrainingData(2).day4 = TrainingData_1695(4);
TrainingData(2).day5 = TrainingData_1695(5);
TrainingData(2).day6 = TrainingData_1695(6);
TrainingData(2).day7 = TrainingData_1695(7);
TrainingData(2).day8 = TrainingData_1695(8);
TrainingData(2).day9 = TrainingData_1695(9);
TrainingData(2).day10 = TrainingData_1695(10);
TrainingData(2).day11 = TrainingData_1695(11);
TrainingData(2).day12 = TrainingData_1695(12);
TrainingData(2).day13 = TrainingData_1695(13);
TrainingData(2).day14 = TrainingData_1695(14);
TrainingData(2).day15 = TrainingData_1695(15);

TrainingData(2).animal = 1697;
TrainingData(2).day1 = TrainingData_1697(1);
TrainingData(2).day2 = TrainingData_1697(2);
...
[TrainingData(g).(F1{p}).TrialStruct, ~] = RTjuice(TempTrialStruct, TempCell{p}.AllLicks, .5);
TrainingData(g).(F1{p}).LickOnsets = FindLickOnsets([TempCell{p}.AllLicks], .5);
RTs = [TrainingData(g).(F1{p}).TrialStruct.RTj];
...
LickOnsetPred(counterP).TrialTime = TrainingData(g).(F1{p}).LickOnsets(n)- TrainingData(g).(F1{p}).TrialStruct(k).FictiveJuice;
counterP = counterP + 1;
end
if TrainingData(g).(F1{p}).LickOnsets(n) > (TrainingData(g).(F1{p}).TrialStruct(k).FictiveTone + .68+.15)
...
LickOnsetReact(counterR).TrialTime = TrainingData(g).(F1{p}).LickOnsets(n)- TrainingData(g).(F1{p}).TrialStruct(k).FictiveJuice;
counterR = counterR +1;
end
end
if TrainingData(g).(F1{p}).LickOnsets(n) > (TrainingData(g).(F1{p}).TrialStruct(k).FictiveTone + .88 + .68)
...
LickOnsetOutside(counterO).TrialTime = TrainingData(g).(F1{p}).LickOnsets(n)- TrainingData(g).(F1{p}).TrialStruct(k).FictiveJuice;
counterO = counterO +1;
end
end
end
...
LickOnsetBefore(counterB).TrialTime = TrainingData(g).(F1{p}).LickOnsets(n)- TrainingData(g).(F1{p}).TrialStruct(k).FictiveJuice;
counterB = counterB +1;
end
end
end
...
%on 'b' or 'j' trials
bRTs = RTs(strcmp({TrainingData(g).(F1{p}).TrialStruct.TrialType}, 'b')); %only RTjs on 'b' trials
RTs(isinf(RTs) | isnan(RTs)) = [];
...
histogram ([TrainingData(g).(F1{p}).LickOnsetPred.TrialTime], [-1.5:.05:45], 'FaceAlpha', .5, 'FaceColor', C(1,:))
end
if ~isempty([TrainingData(g).(F1{p}).LickOnsetReact])
histogram ([TrainingData(g).(F1{p}).LickOnsetReact.TrialTime], [-1.5:.05:45], 'FaceAlpha', .5, 'FaceColor', C(2,:))
end

...
clear N_Empty
figure
for k = 7:26                % edit this for day and edit figure wrap title
...
FigureWrap(NaN, ['SS_trainpk_response_naive_over_days_lickAligned'], NaN, NaN, NaN, NaN, 2.0, 12);
...
% xlabel('time from lick onset');
% xlim([-1 .5]);
% FigureWrap(NaN, ['SS_trainpk_LickResponse_day1' num2str(k)], NaN, NaN, NaN, NaN, NaN, NaN);
% 

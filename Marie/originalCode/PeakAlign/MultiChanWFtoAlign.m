function [time, MainWaveforms, MultiChanWFStruct, Scale] = MultiChanWFtoAlign(struct, dataLength, n, timeLim, TimeGridA, TimeGridB, unit, map, color, PlotSamps, PlotMean, ScalePass)

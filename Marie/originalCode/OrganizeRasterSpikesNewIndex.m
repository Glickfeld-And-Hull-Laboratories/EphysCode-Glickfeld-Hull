function RasterMatrix = OrganizeRasterSpikesNewIndex(struct, NewTrig, unitIndex, xmin, xmax, color2)
% xmin should be postive!!

title_ = num2str(struct(unitIndex).unitID);

unit = struct(unitIndex).timestamps;
%length(unit);

...
function reporter = xCorrStructNewLimitsTGsdlines(TimeGridA, TimeGridB, struct, xmin, xmax, bwidth, unit1, unit2, limMin, limMax, color) %times in seconds, n unit of interest for struct (.unitID= string, .timestamps= vector 
...
N = FreqHist(N, edges, length(Unit1), color);

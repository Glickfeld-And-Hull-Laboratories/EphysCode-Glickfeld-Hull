...
figure
barh(BinEdges, AdjValues, 1, 'k'); %'BaseValue', (timestamps(end) + .01*timestamps(end)) ); using the baseValue puts a subtle gray line I can't get rid off
...
scatter(timestamps, amplitudes, 'k');
%hold on

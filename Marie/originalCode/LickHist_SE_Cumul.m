...
function [N_se, edges, N_mean, N] = LickHist_SE_Cumul(JuiceTimes, LickTimes, range, bwidth)
...
if exist ('useDeltas') 
for j = 1:L1   
[N(:,j), edges] = histcounts([useDeltas{:,j}], 'BinLimits', range, 'Binwidth', bwidth, 'Normalization', 'cumcount');

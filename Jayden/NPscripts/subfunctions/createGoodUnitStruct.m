% Adapted from Marie Hemelt's subfunction CreateGoodStruct.m, copied on 2/19/2025

function [UnitStruct] = createGoodUnitStruct(cluster, SpikeTimes, clustersAllST) % pass only good clusters to get struct of good units & timestamps
clear k
clear j
clear log1
clear k1
